    ...
    public partial class Scene3 : UserControl
    {
        ...
        private void Scene3_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            MainWindow.ShowDialog(new List<DialogEntry>
            {
                ...
                new() { Speaker = "", Text = "Mramor. Strop se světly. Rostlina v rohu. Další výtah před tebou." },
                ...
                new() { Speaker = "Muž", Text = "Tohle je správné patro." },
                new() { Speaker = "", Text = "Vyjde z výtahu. Rozhlédne se, jako by byl doma." },
            });
        }
        ...
        private void ConfirmCode_Click(object sender, RoutedEventArgs e)
        {
            if (CodeInput.Text.Trim() == SpravnyKod)
            {
                ...
                MainWindow.ShowDialog(new List<DialogEntry>
                {
                    ...
                    new() { Speaker = "", Text = "Dveře výtahu se zavírají." },
                }, () =>
                {
            ...
            {
                MainWindow.ShowSingleDialog("", "Červené světlo. Nesprávný kód.");
                CodeInput.Clear();
            }
        }
